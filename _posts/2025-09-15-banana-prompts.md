...
# Nano Banana Gemini Viral Prompts to bring zest in your Insta Posts
## What is Nano Banana
* Codename for a very small experimental Gemini model
* Limited multimodal/image-generation capability compared to larger Gemini variants
* Produces lower-fidelity images with simpler composition and more artifacts
* Faster inference and lower compute requirements suitable for low-resource devices
* Requires clearer, simpler prompts and more post-processing to improve outputs


## Popular Prompts that were helpful 
...
*  Transform this uploaded photo into a cute kawaii-style sticker with the person with expressive face, featuring bold clean outlines, vibrant colors, exaggerated cute proportions with big expressive eyes, cartoon-like expression or pose, simple cel-shading for depth, and a plain white background
*  Generate a high-resolution image that takes the people in my photo and transforms them into a beautiful, standalone watercolor illustration. Place the subjects within a highly detailed, fun, snowy outdoor winter scene, featuring snow-laden evergreen trees and crisp white snow under bright winter daylight. Place festive, hand-drawn watercolor lettering at the top of the image that reads "HAPPY HOLIDAYS" in brushed deep red and forest green tones, blended harmoniously into the painted sky. 16:9 aspect ratio. Do not include any logos or brand names.
...
#### Transform Photos
*  Generate a nostalgic Polaroid-style photo of two people hugging warmly. Keep their faces clearly visible and natural, with authentic expressions of joy and affection. Use indoor lighting with a slight flash effect and subtle blur to mimic a real instant photo. Include a soft background and maintain the classic Polaroid frame aesthetic for a cozy, heartfelt feel.
*  Convert my selfie into a sharp, authoritative headshot perfect for law firm partnerships and legal directories. The lighting should be classic and timeless with controlled shadows. My expression is serious yet personable, shoulders square to camera. The background is a traditional mahogany-paneled office with law books, elegantly blurred.
*  Create a 4K HD realistic portrait of a young Indian man with same hair. He is wearing a blazer with a striped shirt and has a same moustache. There is an old long car behind him and he is standing right in front of him leaning on the car.  The background is a huge forest in daylight. The overall mood is retro and artistic.
...
*  Create 3d model of statue in middle. Make sure to remove all the people from area. Create breath taking sky with night time. keep hills in background but make the photo from far to add landscape ultrawide effect.
*  Create a 3d view from top of sky using photos uploaded like taking a photo from top using drone.
